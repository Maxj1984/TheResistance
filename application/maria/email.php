...
$body = "Nombre de Postulante: " .$nombre. "<br> correo  electronico: ".$correo."<br>Dirección de Domicilio: ".$direccion."<br>Número de telefono: ".$numero."<br>Fecha: ".$fecha. "<br>Nivel Academico: ".$nivel."<br>Jornada: ".$jorn."<br>Vacante: ".$Vacante;
...
try {
	...
	$mail->addAttachment($foto,"Fotografía .".$jp);
