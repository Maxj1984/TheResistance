<?php
class mantenimientofController extends Controller
{
	...
	function __construct()
	{
		...
		$this->modelo = $this->loadModel('mantenimientof');	
	}
	...
	function index()
	{
		...
		$this->view->rendering('mantenimientof');
	}
	...
	function mdatatable()
	{
		...
		$this->view->rendering('mdatatable');
	}
	
	/* funcion para obtener datos para DataTable	*/
	public function obtener_consulta_detalle()
	{
		$params=array('operacion'=>'obtener_consulta_detalle');
	...
	{
		$params=array('operacion'=>'consulta_detalle');
		$respuesta= $this->modelo->consultas($params);
		echo json_encode($respuesta);
